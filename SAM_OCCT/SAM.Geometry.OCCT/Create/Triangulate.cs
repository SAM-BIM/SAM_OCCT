...
namespace SAM.Geometry.OCCT
{
    ...
    {
        /// <summary>
        /// Triangulates the boundary of each input face into planar SAM Face3Ds using OCCT.
        /// Coplanar boundaries are meshed as a plane; non-planar (warped) boundaries are spanned
        /// with an OCCT filling surface and meshed into planar triangles. Every returned Face3D is
        /// a triangle, so all outputs are guaranteed planar.
        /// </summary>
        ...
        public static List<Face3D> Triangulate(IEnumerable<Face3D> face3Ds, out OcctCellComplexResult result, double linearDeflection = 0.1, double angularDeflection = 0.5, bool relativeDeflection = false, OcctBuildOptions options = null)
        {
            ...
            if (!Native.OcctCellComplexBuilder.TryTriangulate(face3Ds_Temp, options, linearDeflection, angularDeflection, relativeDeflection, result, out List<Face3D> triangles))
            {
                return null;
            }
        ...
        public static List<Face3D> Triangulate(IEnumerable<Face3D> face3Ds, out OcctCellComplexResult result, double linearDeflection, double tolerance)
        {
