...
namespace SAM.Geometry.OCCT
{
    ...
    {
        /// <summary>
        /// Hollows each shell's solid into a wall of the given
        /// <paramref name="thickness"/> via OCCT BRepOffsetAPI_MakeThickSolid
        /// (issue #29) - e.g. turning a zone volume into its enclosing
        /// construction / plenum shell. Returns null on failure - inspect
