...
{
    public class SAMOCCTImportStep : GH_SAMVariableOutputParameterComponent
    {
        public override Guid ComponentGuid => new Guid("2cda42f9-a65b-4ac2-aa22-7b13169c12c4");

        public override string LatestComponentVersion => "0.1.0";

        protected override System.Drawing.Bitmap Icon => SAMOCCTIcon.SAM_OCCT24;

        public SAMOCCTImportStep()
          : base("SAMOCCT.ImportSTEP", "SAMOCCT.ImportSTEP", "Import a STEP file into closed SAM Shell volumes using OCCT", "SAM", "OCCT")
        {
        }
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_path", NickName = "_path", Description = "Full path of the STEP file to read (.stp / .step).", Access = GH_ParamAccess.item }, ParamVisibility.Binding));

                global::Grasshopper.Kernel.Parameters.Param_Number tolerance = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "tolerance_", NickName = "tolerance_", Description = "OCCT decode tolerance [m]", Access = GH_ParamAccess.item };
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "Shells", NickName = "Shells", Description = "Closed SAM Shell volumes decoded from the STEP file.", Access = GH_ParamAccess.list }, ParamVisibility.Binding));
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            List<Shell> shells = Geometry.OCCT.Create.Shells(path, OcctExchangeFormat.Step, out OcctCellComplexResult result, new OcctBuildOptions { Tolerance = tolerance });
