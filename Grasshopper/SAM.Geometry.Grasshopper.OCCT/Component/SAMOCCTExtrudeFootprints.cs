    ...
    public class SAMOCCTExtrudeFootprints : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                global::Grasshopper.Kernel.Parameters.Param_Number height = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_height", NickName = "_height", Description = "Vertical extrusion height [m] (extrudes each footprint along +Z).", Access = GH_ParamAccess.item };
