...
{
    public class SAMOCCTImportIges : GH_SAMVariableOutputParameterComponent
    {
        public override Guid ComponentGuid => new Guid("ca490387-af35-42f8-ab58-eeed11c4d30d");
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_path", NickName = "_path", Description = "Full path of the IGES file to read (.igs / .iges).", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "Shells", NickName = "Shells", Description = "Closed SAM Shell volumes decoded from the IGES file. IGES is surface-based, so a file without closed solids may decode to no shells.", Access = GH_ParamAccess.list }, ParamVisibility.Binding));
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            List<Shell> shells = Geometry.OCCT.Create.Shells(path, OcctExchangeFormat.Iges, out OcctCellComplexResult result, new OcctBuildOptions { Tolerance = tolerance });
