...
{
    public class SAMOCCTShellsDifference : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                global::Grasshopper.Kernel.Parameters.Param_GenericObject shells = new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "_shells", NickName = "_shells", Description = "Closed target volumes to keep and cut. Accepts SAM Shells or closed Rhino Breps/polysurfaces that convert to SAM Shells.", Access = GH_ParamAccess.list };
                shells.DataMapping = GH_DataMapping.Flatten;
                result.Add(new GH_SAMParam(shells, ParamVisibility.Binding));

                global::Grasshopper.Kernel.Parameters.Param_GenericObject cutterShells = new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "_cutterShells", NickName = "_cutterShells", Description = "Closed cutting volumes to remove from _shells. Accepts SAM Shells or closed Rhino Breps/polysurfaces. Surfaces/Face3Ds must first become closed Shells.", Access = GH_ParamAccess.list };
                cutterShells.DataMapping = GH_DataMapping.Flatten;
                result.Add(new GH_SAMParam(cutterShells, ParamVisibility.Binding));
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "Shells", NickName = "Shells", Description = "Target shells after cutter volumes have been removed.", Access = GH_ParamAccess.list }, ParamVisibility.Binding));
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            index = Params.IndexOfInputParam("_cutterShells");
            if (index == -1 || !dataAccess.GetDataList(index, cutterShellWrappers) || cutterShellWrappers == null)
            {
