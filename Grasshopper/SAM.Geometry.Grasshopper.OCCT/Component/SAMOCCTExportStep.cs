...
{
    public class SAMOCCTExportStep : GH_SAMVariableOutputParameterComponent
    {
        public override Guid ComponentGuid => new Guid("06b9f970-65db-4884-a936-4ea119411c3e");

        public override string LatestComponentVersion => "0.1.0";

        protected override System.Drawing.Bitmap Icon => SAMOCCTIcon.SAM_OCCT24;

        public SAMOCCTExportStep()
          : base("SAMOCCT.ExportSTEP", "SAMOCCT.ExportSTEP", "Export closed SAM Shell volumes to a STEP file using OCCT", "SAM", "OCCT")
        {
        }
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_path", NickName = "_path", Description = "Full path of the STEP file to write (.stp / .step).", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            bool successful = Geometry.OCCT.Export.ToFile(shells, path, OcctExchangeFormat.Step, out OcctCellComplexResult result, new OcctBuildOptions { Tolerance = tolerance, FuzzyTolerance = fuzzyTolerance });
